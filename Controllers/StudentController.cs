...
public class StudentsController : Controller
{
    ...
    public async Task<IActionResult> GradeAssignment(UserAssignment updatedUserAssignment)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            originalAssignment.IsSubmitted = updatedUserAssignment.IsSubmitted; // You may update this depending on your UI/UX
            originalAssignment.SubmissionDate = updatedUserAssignment.SubmissionDate; // You may also update this
